...
from models.ggnn_sg_model import Classifier
...
def main(args):
    ...
    prefix='ggnn_sg_model_'+dataset+'_'+bdir+'_'+str(args.n_layers)+'_'+str(args.n_steps)+'_'+args.readout+'_'+str(app_io)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='GraphGNN')
