...
from models.appnp_sg_model import Classifier
...
def main(args):
    ...
    prefix='appnp_sg_model_'+dataset+'_'+bdir+'_'+str(args.n_layers)+'_'+str(args.n_hidden)+'_'+str(args.K)+'_'+str(args.alpha)+'_'+args.readout+'_'+str(app_io)
    ...
    print('A APPNP Graph Classifier is being trained')
