...
from models.gcaps_sg_model import Classifier
...
def main(args):
    ...
    prefix='gcaps_sg_model_'+dataset+'_'+bdir+'_'+str(args.n_layers)+'_'+str(args.n_hidden)+'_'+str(args.in_stats)+'_'+str(args.out_stats)+'_'+str(args.gfc_layers)+'_'+args.readout+'_'+str(args.dropout)+'_'+str(app_io)+'_'+str(args.K)+'_'+str(batch_io)
    ...
    trainset=ShockGraphDataset(train_dir,dataset,norm_factors,app=app_io,cache=cache_io,symmetric=symm_io,data_augment=apply_da,grid=args.n_grid)
    ...
    print('A Graph Capsule Network Graph Classifier is being trained')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--in_stats", type=int, default=2,
                        help="number of in stats")
    parser.add_argument("--out_stats", type=int, default=2,
                        help="number of out stats")                                    
    parser.add_argument("--gfc_layers", type=int, default=2,
                        help="number of gfc layers")                                    
