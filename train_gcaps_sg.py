...
def main(args):
    ...
    prefix='data-'+str(bdir)+':'+str(dataset)+'_m-gcaps_ni-'+str(input_dim)+'_nh-'+str(args.n_hidden)+'_lay-'+str(args.n_layers)+'_in-'+str(args.in_stats)+'_out-'+str(args.out_stats)+'_gfc-'+str(args.gfc_layers)+'_napp-'+str(napp)+'_eapp-'+str(eapp)+'_do-'+str(args.dropout)+'_ro-'+str(args.readout)
